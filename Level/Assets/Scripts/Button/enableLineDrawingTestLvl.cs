...
public class enableLineDrawingTestLvl : MonoBehaviour {
	...
	private DrawPhysicsLineTestLvl drawingComponent;
	...
	void Start () {
		...
		canDraw = false;
		drawingComponent = gameObject.GetComponent<DrawPhysicsLineTestLvl> ();
	}
}
